...
const UpComing = () => {
    ...
    const showPage = (newPage) => {
        try {
            axios(`https://api.themoviedb.org/3/movie/upcoming?api_key=${ApiKey}&language=en-US&page=${newPage || 1}`)
    ...
    return (
        <div className="" style={{
            ...
            <div className="container mx-auto flex flex-wrap p-10 flex-col md:flex-row items-center mx-auto  ">
                <h1 className="text-3xl w-full text-white py-5 font-bold text-center sm:text-left">Up Coming movies</h1>
